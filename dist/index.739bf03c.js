...
function navbar() {
    ...
    /* EXPANDING MENU IF CLICKED ON MOBILE */ function expandMenu() {
        let isMenuOpen;
        menuIcon.classList.toggle("active");
        navMenu.classList.toggle("active");
        isMenuOpen = !isMenuOpen;
        menuIcon.setAttribute("aria-label", isMenuOpen ? "Close navigation" : "Open navigation");
        menuIcon.setAttribute("aria-expanded", isMenuOpen);
    }
    const navLink = document.querySelectorAll(".nav-link");
    navLink.forEach((n)=>n.addEventListener("click", closeMenu));
    /* CLOSING MENU */ function closeMenu() {
        menuIcon.classList.remove("active");
        navMenu.classList.remove("active");
    }
    /* SCROLLING STICKY NAVBAR */ let lastScrollTop = 0;
...
},{}],"eeEcT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"swiper":"iM6UL","swiper/modules":"9ktz6","swiper/swiper-bundle.css":"aErfw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iM6UL":[function(require,module,exports) {
/**
 * Swiper 11.1.14
...
function shop() {
    ...
    /* UPDATING COUNTER VALUES WHEN CLICKED ON + OR - BUTTONS */ function changeValueHandler(event) {
        const counter = event.target.closest(".counter-container").querySelector(".count");
        const updateCounterValue = parseInt(counter.value) + (event.target.value === "+" ? 1 : -1);
        if (updateCounterValue >= 0) counter.value = updateCounterValue;
    }
    /* SETTING ACCORDION BEHAVIOUR AND APPLYING CLASSES*/ const headers = document.querySelectorAll(".accordion-header");
    ...
    /* SETTING FIRST ACCORDION ELEMENT TO OPEN*/ if (headers.length > 0) headers[0].click();
    /* ADDING PRODUCT TO CART ANIMATION*/ document.querySelectorAll(".cart-button").forEach((button)=>button.addEventListener("click", (e)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequire94c2")
